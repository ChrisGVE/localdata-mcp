# <img src="assets/logo.png" alt="LocalData MCP Server" width="144" height="72" style="vertical-align: middle; margin-right: 16px;"Localdata MCP Server> LocalData MCP Server
