...
@tool_spec(
    ...
    params=(
        ...
        Param("direction", str, "'in', 'out', or 'both' (default)."),
...
@tool_spec(
    ...
    params=(
        Param("endpoint", str, "The operator-declared graph endpoint name."),
        Param("node_id", str, "Optional node filter."),
        Param("offset", int, "Pagination offset (default 0)."),
        Param("limit", int, "Optional page size; omitted serves all rows."),
    ),
    input_shape=TypeShape.NONE,
...
@tool_spec(
    ...
    params=(
        ...
        Param("label", str, "Optional edge label."),
        Param("weight", float, "Optional edge weight."),
    ),
    input_shape=TypeShape.NONE,
...
@tool_spec(
    ...
    params=(
        ...
        Param("source", str, "The edge's source node id."),
        Param("target", str, "The edge's target node id."),
        Param("label", str, "Optional edge label (NULL-labeled when omitted)."),
    ),
    input_shape=TypeShape.NONE,
    output_shape=TypeShape.SCALAR,
    domain="ingest",
...
@tool_spec(
    ...
    params=(
        ...
        Param("algorithm", str, "'shortest' (default) or 'all'."),
    ),
    input_shape=TypeShape.NONE,
    output_shape=TypeShape.SCALAR,
    domain="ingest",
