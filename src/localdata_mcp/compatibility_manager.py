...
class CompatibilityManager:
    ...
    def warn_deprecated(
        self, feature_key: str, additional_context: Optional[str] = None
    ) -> None:
        """
...
"""
    ...
    def check_api_compatibility(
        ...
        """
        compatibility_info = {"compatible": True, "warnings": [], "suggestions": []}
    ...
    def migrate_legacy_response_format(
        self, response: Any, format_version: str = "v1.3.0"
    ) -> Any:
        """
    ...
    def enable_compatibility_mode(self, enabled: bool = True) -> None:
        ...
        if enabled:
            logger.info(
                "Compatibility mode enabled - maximum backward compatibility active"
            )
        else:
