...
# Tests for analytical formats with comprehensive mocking - all tests enabled for 100% coverage
...
class TestAnalyticalFormats:
    ...
    def test_large_analytical_file_handling(self, manager):
        ...
        try:
            ...
            query_result = manager.execute_query("large_parquet", "SELECT COUNT(*) as total FROM data_table")
