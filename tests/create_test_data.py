...
sample_data = {
    ...
    "Start_Date": pd.to_datetime(
        ["2020-01-15", "2019-03-22", "2021-07-10", "2020-11-05", "2022-02-28"]
    ),
...
def create_ini_files():
    ...
    config["cache"] = {"enabled": "true", "ttl": "3600", "max_size": "1000"}

    config["logging"] = {"level": "INFO", "file": "app.log", "max_files": "5"}
...
def create_analytical_format_files():
    ...
    try:
        ...
        print(
            "Warning: pyarrow not available, skipping analytical format file creation"
        )
    except Exception as e:
