...
class TestResultBuffer:
    ...
    def test_result_buffer_initialization(self):
        ...
        buffer = ResultBuffer(
            "test_query_1", "test_db", "SELECT * FROM test", max_memory_mb=100
        )
    ...
    def test_result_buffer_memory_limit(self):
        ...
        buffer = ResultBuffer(
            "test_query_1", "test_db", "SELECT * FROM test", max_memory_mb=1
        )  # Very small limit
...
class TestStreamingFileSource:
    ...
    def test_json_streaming(self):
        ...
        try:
            ...
            assert all(
                "id" in chunk.columns and "value" in chunk.columns for chunk in chunks
            )
