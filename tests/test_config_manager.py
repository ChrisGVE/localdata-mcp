...
class TestLoggingConfig:
    ...
    def test_valid_logging_config(self):
        ...
        config = LoggingConfig(level=LogLevel.DEBUG, file_path="/var/log/localdata.log")
...
class TestPerformanceConfig:
    ...
    def test_valid_performance_config(self):
        ...
        config = PerformanceConfig(
            memory_limit_mb=4096, chunk_size=200, memory_warning_threshold=0.9
        )
    ...
    def test_invalid_memory_threshold(self):
        ...
        with pytest.raises(
            ValueError, match="memory_warning_threshold must be between 0 and 1"
        ):
...
class TestConfigManager:
    ...
    def test_config_file_discovery(self):
        ...
        # Test current directory discovery (hidden file, matches config_paths)
