...
from localdata_mcp.pipeline.missing_value_handler import (
    MissingValueHandler,
    MissingValuePattern,
    ImputationQuality,
    ImputationMetadata,
)
from localdata_mcp.pipeline.base import StreamingConfig
...
class TestMissingValueHandler:
    ...
    def test_initialization_custom(self):
        ...
        custom_params = {
            "strategy_config": {"knn": {"n_neighbors": 10, "weights": "distance"}}
        }
    ...
    def test_missing_pattern_analysis_mcar(self, sample_data_mcar):
        ...
        assert handler._missing_pattern.pattern_type in [
            "MCAR",
            "MAR",
        ]  # Could be either due to randomness
    ...
    def test_iterative_imputation(self, sample_data_mcar):
        ...
        with patch.object(
            handler, "_select_optimal_strategy", return_value="iterative"
        ):
            processed_data, metadata = handler.analyze(sample_data_mcar)
    ...
    def test_streaming_compatibility(self, sample_data_mcar):
        ...
        streaming_config = StreamingConfig(
            chunk_size=100, memory_limit_mb=50, enable_streaming=True
        )
    ...
    def test_fitted_imputers_storage(self, sample_data_mcar):
        ...
        original_missing_cols = sample_data_mcar.columns[
            sample_data_mcar.isnull().any()
        ].tolist()
    ...
    def test_integration_with_cleaning_pipeline(self, sample_data_mcar):
        ...
        from localdata_mcp.pipeline.preprocessing import DataCleaningPipeline
        ...
        missing_value_ops = [
            ...
            if "missing" in op.get("operation_type", "").lower()
        ]
    ...
    def test_progressive_disclosure_levels(self, sample_data_mcar):
        ...
        data_comprehensive, meta_comprehensive = handler_comprehensive.analyze(
            sample_data_mcar.copy()
        )
