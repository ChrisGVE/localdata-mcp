...
class TestEdgeCases:
    ...
    def test_memory_pressure_handling(self, manager):
        ...
        try:
            ...
            # Query should work
            query_result = manager.execute_query_json("large_test", "SELECT COUNT(*) FROM data_table")
    ...
    def test_query_buffer_expiry(self, manager):
        ...
        try:
            ...
            query_result = manager.execute_query_json("buffer_test", "SELECT * FROM data_table")
            ...
            chunk_result = manager.get_query_chunk(query_id, 1, "10")
