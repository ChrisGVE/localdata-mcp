...
class TestSamplingTransformer:
    ...
    def test_simple_random_sampling(self, sample_data):
        ...
        transformer = SamplingTransformer(
            sampling_method="simple_random", sample_size=100, random_state=42
        )
    ...
    def test_systematic_sampling(self, sample_data):
        ...
        transformer = SamplingTransformer(
            sampling_method="systematic", sample_size=100, random_state=42
        )
    ...
    def test_quality_metrics_calculation(self, sample_data):
        ...
        transformer = SamplingTransformer(
            sampling_method="simple_random", sample_size=200, random_state=42
        )
...
class TestBootstrapTransformer:
    ...
    def test_bootstrap_mean(self, sample_data):
        ...
        transformer = BootstrapTransformer(
            statistic_func="mean", n_bootstrap=1000, random_state=42
        )
    ...
    def test_bootstrap_median(self, sample_data):
        ...
        transformer = BootstrapTransformer(
            statistic_func="median", n_bootstrap=500, random_state=42
        )
    ...
    def test_bootstrap_custom_function(self, sample_data):
        ...
        transformer = BootstrapTransformer(
            statistic_func=custom_stat, n_bootstrap=200, random_state=42
        )
    ...
    def test_confidence_intervals(self, sample_data):
        ...
        for bootstrap_result in transformer.bootstrap_results_:
            ...
            for ci_name, (
                lower,
                upper,
            ) in bootstrap_result.confidence_intervals.items():
                assert lower < upper
                assert (
                    lower <= bootstrap_result.original_statistic <= upper
                    or abs(bootstrap_result.original_statistic - (lower + upper) / 2)
                    < 3 * bootstrap_result.standard_error
                )

    def test_bca_method(self, sample_data):
        """Test BCa bootstrap method."""
        transformer = BootstrapTransformer(
            statistic_func="mean", method="bca", n_bootstrap=500, random_state=42
        )
...
class TestMonteCarloTransformer:
    ...
    def test_uncertainty_quantification(self, sample_data):
        ...
        transformer = MonteCarloTransformer(
            simulation_type="uncertainty", n_simulations=5000, random_state=42
        )
    ...
    def test_importance_sampling(self, sample_data):
        ...
        transformer = MonteCarloTransformer(
            simulation_type="importance", n_simulations=10000, random_state=42
        )
    ...
    def test_mcmc_sampling(self, sample_data):
        ...
        transformer = MonteCarloTransformer(
            simulation_type="mcmc", n_simulations=5000, random_state=42
        )
    ...
    def test_convergence_diagnostics(self, sample_data):
        ...
        transformer = MonteCarloTransformer(
            simulation_type="integration", n_simulations=1000, random_state=42
        )
...
class TestBayesianEstimationTransformer:
    ...
    def test_normal_conjugate_prior(self, sample_data):
        ...
        for bayesian_result in transformer.bayesian_results_:
            assert bayesian_result.estimation_method in [
                "normal_conjugate",
                "approximate",
            ]
    ...
    def test_credible_intervals(self, sample_data):
        ...
        transformer = BayesianEstimationTransformer(
            estimation_type="credible_interval", confidence_level=0.95, random_state=42
        )
    ...
    def test_model_comparison(self, sample_data):
        ...
        transformer = BayesianEstimationTransformer(
            estimation_type="model_comparison", random_state=42
        )
    ...
    def test_posterior_samples_quality(self, sample_data):
        ...
        transformer = BayesianEstimationTransformer(
            estimation_type="posterior", n_samples=10000, random_state=42
        )
...
class TestIntegrationAndEdgeCases:
    ...
    def test_small_dataset_handling(self):
        ...
        small_data = pd.DataFrame(
            {"values": [1, 2, 3, 4, 5], "category": ["A", "A", "B", "B", "C"]}
        )
    ...
    def test_single_column_data(self):
        ...
        single_col_data = pd.DataFrame({"values": np.random.normal(50, 10, 100)})
    ...
    def test_reproducibility(self):
        ...
        data = pd.DataFrame({"values": np.random.normal(10, 2, 200)})
    ...
    def test_performance_with_large_bootstrap(self):
        ...
        bootstrapper = BootstrapTransformer(
            statistic_func="mean", n_bootstrap=10000, random_state=42
        )
