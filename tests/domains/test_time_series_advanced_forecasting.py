...
class TestAdvancedForecastingTransformer:
    ...
    def test_initialization(self):
        ...
        transformer = AdvancedForecastingTransformer(
            method="exponential_smoothing", forecast_steps=20, confidence_level=0.90
        )
    ...
    def test_seasonality_detection(self, sample_time_series):
        ...
        random_data = pd.Series(
            np.random.random(100), index=pd.date_range("2020-01-01", periods=100)
        )
    ...
    def test_fit_exponential_smoothing_method(self, sample_forecasting_data):
        ...
        transformer = AdvancedForecastingTransformer(
            method="exponential_smoothing", forecast_steps=10
        )
    ...
    def test_fit_ensemble_method(self, sample_forecasting_data):
        ...
        transformer = AdvancedForecastingTransformer(
            method="ensemble", forecast_steps=10
        )
    ...
    def test_transform_generates_forecasts(self, sample_forecasting_data):
        ...
        transformer = AdvancedForecastingTransformer(
            method="exponential_smoothing", forecast_steps=5
        )
...
class TestExponentialSmoothingForecaster:
    ...
    def test_auto_component_detection(self, sample_forecasting_data):
        ...
        forecaster = ExponentialSmoothingForecaster(
            trend="auto", seasonal="auto", forecast_steps=5
        )
...
class TestEnsembleForecaster:
    ...
    def test_model_initialization(self, sample_forecasting_data):
        ...
        forecaster = EnsembleForecaster(methods=["exponential_smoothing", "arima"])
    ...
    def test_confidence_intervals_combination(self):
        ...
        intervals = {
            "method1": pd.DataFrame(
                {"lower": [95, 100, 105], "upper": [105, 110, 115]}
            ),
...
class TestIntegration:
    ...
    def test_advanced_forecasting_with_exponential_smoothing(
        self, sample_forecasting_data
    ):
    ...
    def test_evaluation_with_real_forecasts(self, sample_forecasting_data):
        ...
        # Generate forecasts
        forecaster = ExponentialSmoothingForecaster(
            forecast_steps=len(test_data), trend="add", seasonal=None
        )
        ...
        assert report["performance_category"] in [
            "excellent",
            "good",
            "moderate",
            "poor",
