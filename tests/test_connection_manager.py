...
class TestEnhancedConnectionManager:
    ...
    def setup_method(self):
        ...
        self.mock_config_manager.get_database_configs.return_value = {
            "test_db": self.test_config
        }
        ...
        self.mock_config_manager.get_performance_config.return_value = (
    ...
    @patch("localdata_mcp.connection_manager.manager.get_config_manager")
    @patch("localdata_mcp.connection_manager.manager.get_timeout_manager")
    ...
    def test_query_failure_tracking(self, mock_timeout_mgr, mock_config_mgr):
        ...
        with pytest.raises(ValueError):
            with manager.managed_query_execution(
                "test_db", "test_query_fail"
            ) as context:
    ...
    def test_postgresql_engine_creation(self, mock_timeout_mgr, mock_config_mgr):
        ...
        with (
            patch(
                "localdata_mcp.connection_manager.engine_factory.create_engine"
            ) as mock_create,
...
class TestGlobalConnectionManager:
    ...
    def test_singleton_behavior(self):
        ...
        import localdata_mcp.connection_manager as cm_module
