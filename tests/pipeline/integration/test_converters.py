...
class TestPandasConverter:
    ...
    def test_numpy_to_dataframe_conversion(self):
        ...
        request = create_conversion_request(
            test_array, DataFormat.NUMPY_ARRAY, DataFormat.PANDAS_DATAFRAME
        )
    ...
    def test_dataframe_to_sparse_conversion(self):
        ...
        sparse_data = pd.DataFrame(
            {"col1": [1, 0, 0, 2, 0], "col2": [0, 0, 3, 0, 0], "col3": [0, 4, 0, 0, 5]}
        )

        request = create_conversion_request(
            sparse_data, DataFormat.PANDAS_DATAFRAME, DataFormat.SCIPY_SPARSE
        )
    ...
    def test_dataframe_to_dict_conversion(self):
        ...
        request = create_conversion_request(
            self.sample_df, DataFormat.PANDAS_DATAFRAME, DataFormat.PYTHON_DICT
        )
    ...
    def test_dataframe_to_list_conversion(self):
        ...
        request = create_conversion_request(
            self.sample_df, DataFormat.PANDAS_DATAFRAME, DataFormat.PYTHON_LIST
        )
    ...
    def test_categorical_conversion(self):
        ...
        request = create_conversion_request(
            low_cardinality_df, DataFormat.PANDAS_DATAFRAME, DataFormat.CATEGORICAL
        )
    ...
    def test_conversion_options_handling(self):
        ...
        options = ConversionOptions(
            preserve_index=False, preserve_columns=False, handle_mixed_types=False
        )
    ...
    def test_error_handling(self):
        ...
        request = create_conversion_request(
            "not_a_dataframe", DataFormat.PANDAS_DATAFRAME, DataFormat.NUMPY_ARRAY
        )
    ...
    def test_large_dataframe_handling(self):
        ...
        request = create_conversion_request(
            large_df, DataFormat.PANDAS_DATAFRAME, DataFormat.NUMPY_ARRAY
        )
...
class TestNumpyConverter:
    ...
    def test_numpy_to_dataframe_2d(self):
        ...
        request = create_conversion_request(
            self.array_2d, DataFormat.NUMPY_ARRAY, DataFormat.PANDAS_DATAFRAME
        )
    ...
    def test_numpy_to_dataframe_1d(self):
        ...
        request = create_conversion_request(
            self.array_1d, DataFormat.NUMPY_ARRAY, DataFormat.PANDAS_DATAFRAME
        )
    ...
    def test_numpy_to_dataframe_3d(self):
        ...
        request = create_conversion_request(
            self.array_3d, DataFormat.NUMPY_ARRAY, DataFormat.PANDAS_DATAFRAME
        )
    ...
    def test_numpy_to_sparse_conversion(self):
        ...
        request = create_conversion_request(
            sparse_array, DataFormat.NUMPY_ARRAY, DataFormat.SCIPY_SPARSE
        )
    ...
    def test_numpy_to_list_conversion(self):
        ...
        request = create_conversion_request(
            self.array_2d, DataFormat.NUMPY_ARRAY, DataFormat.PYTHON_LIST
        )
    ...
    def test_numpy_to_dict_conversion(self):
        ...
        request = create_conversion_request(
            self.array_2d, DataFormat.NUMPY_ARRAY, DataFormat.PYTHON_DICT
        )
    ...
    def test_mixed_type_dataframe_to_numpy(self):
        ...
        request = create_conversion_request(
            mixed_df, DataFormat.PANDAS_DATAFRAME, DataFormat.NUMPY_ARRAY
        )
    ...
    def test_dtype_preservation(self):
        ...
        request = create_conversion_request(
            int_array, DataFormat.NUMPY_ARRAY, DataFormat.PYTHON_DICT
        )
...
class TestSparseMatrixConverter:
    ...
    def setup_method(self):
        ...
        self.sparse_array = np.array(
            [[1, 0, 0, 2], [0, 0, 3, 0], [4, 0, 0, 0], [0, 5, 0, 0]]
        )
    ...
    def test_sparse_to_dataframe_conversion(self):
        ...
        request = create_conversion_request(
            self.csr_matrix, DataFormat.SCIPY_SPARSE, DataFormat.PANDAS_DATAFRAME
        )
        ...
        np.testing.assert_array_equal(
            result.converted_data.values, self.csr_matrix.toarray()
        )

    def test_sparse_to_numpy_conversion(self):
        """Test sparse matrix to NumPy array conversion."""
        request = create_conversion_request(
            self.csc_matrix, DataFormat.SCIPY_SPARSE, DataFormat.NUMPY_ARRAY
        )
    ...
    def test_sparse_to_dict_conversion(self):
        ...
        request = create_conversion_request(
            self.coo_matrix, DataFormat.SCIPY_SPARSE, DataFormat.PYTHON_DICT
        )
    ...
    def test_dataframe_to_sparse_conversion(self):
        """Test DataFrame to sparse matrix conversion."""
        request = create_conversion_request(
            self.sparse_df, DataFormat.PANDAS_DATAFRAME, DataFormat.SCIPY_SPARSE
        )
        ...
        # Check data integrity
        np.testing.assert_array_equal(
            result.converted_data.toarray(), self.sparse_df.values
        )

    def test_numpy_to_sparse_conversion(self):
        """Test NumPy array to sparse matrix conversion."""
        request = create_conversion_request(
            self.sparse_array, DataFormat.NUMPY_ARRAY, DataFormat.SCIPY_SPARSE
        )
        ...
        # Check data integrity
        np.testing.assert_array_equal(
            result.converted_data.toarray(), self.sparse_array
        )
    ...
    def test_dict_to_sparse_restoration(self):
        ...
        sparse_to_dict_request = create_conversion_request(
            self.csr_matrix, DataFormat.SCIPY_SPARSE, DataFormat.PYTHON_DICT
        )
        ...
        dict_to_sparse_request = create_conversion_request(
            dict_result.converted_data, DataFormat.PYTHON_DICT, DataFormat.SCIPY_SPARSE
        )
        ...
        # Check data integrity
        np.testing.assert_array_equal(
            sparse_result.converted_data.toarray(), self.csr_matrix.toarray()
        )
    ...
    def test_density_threshold_warnings(self):
        ...
        request = create_conversion_request(
            dense_array, DataFormat.NUMPY_ARRAY, DataFormat.SCIPY_SPARSE
        )
    ...
    def test_different_sparse_formats(self):
        ...
        for sparse_mat in formats:
            request = create_conversion_request(
                sparse_mat, DataFormat.SCIPY_SPARSE, DataFormat.NUMPY_ARRAY
            )
    ...
    def test_1d_array_to_sparse_handling(self):
        ...
        request = create_conversion_request(
            array_1d, DataFormat.NUMPY_ARRAY, DataFormat.SCIPY_SPARSE
        )
...
class TestFactoryFunctions:
    ...
    def test_factory_with_custom_options(self):
        ...
        custom_options = ConversionOptions(
            preserve_index=False, sparse_density_threshold=0.2
        )
...
class TestEdgeCases:
    ...
    def test_empty_dataframe_conversion(self):
        ...
        request = create_conversion_request(
            empty_df, DataFormat.PANDAS_DATAFRAME, DataFormat.NUMPY_ARRAY
        )
    ...
    def test_single_value_conversions(self):
        ...
        request = create_conversion_request(
            single_value_df, DataFormat.PANDAS_DATAFRAME, DataFormat.NUMPY_ARRAY
        )
    ...
    def test_very_sparse_matrix_conversion(self):
        ...
        request = create_conversion_request(
            very_sparse, DataFormat.SCIPY_SPARSE, DataFormat.PYTHON_DICT
        )
