...
class TestPipelineCompatibilityMatrix(unittest.TestCase):
    ...
    def test_get_compatibility_same_format(self):
        ...
        score = self.matrix.get_compatibility(
    ...
    def test_domain_profiles(self):
        ...
        self.assertIn(
            DataFormat.PANDAS_DATAFRAME, stats_profile.base_requirements.input_formats
        )
    ...
    def test_validate_pipeline_compatible_steps(self):
        ...
        result = self.matrix.validate_pipeline(
    ...
    def test_validate_pipeline_unknown_domain(self):
        ...
        result = self.matrix.validate_pipeline(
            ["unknown_domain", "statistical_analysis"]
        )
    ...
    def test_caching_behavior(self):
        ...
        # First request
        score1 = matrix_with_cache.get_compatibility(
            DataFormat.PANDAS_DATAFRAME, DataFormat.NUMPY_ARRAY
        )

        # Second request should hit cache
        score2 = matrix_with_cache.get_compatibility(
            DataFormat.PANDAS_DATAFRAME, DataFormat.NUMPY_ARRAY
        )
    ...
    def test_conversion_path_creation(self):
        ...
        path = self.matrix.find_conversion_path(
            DataFormat.PANDAS_DATAFRAME, DataFormat.NUMPY_ARRAY
        )
    ...
    def test_format_family_compatibility(self):
        ...
        score = self.matrix.get_compatibility(
            DataFormat.PYTHON_LIST, DataFormat.STATISTICAL_RESULT
        )
...
class TestUtilityFunctions(unittest.TestCase):
    ...
    def test_assess_pipeline_compatibility(self):
        ...
        result = assess_pipeline_compatibility(
            ["statistical_analysis", "regression_modeling"]
        )
    ...
    def test_suggest_pipeline_improvements(self):
        ...
        suggestions = suggest_pipeline_improvements(
...
class TestCompatibilityMatrix(unittest.TestCase):
    ...
    def test_end_to_end_pipeline_assessment(self):
        ...
        if not result.is_valid:
            ...
            self.assertTrue(
                all(
                    isinstance(error, str) and len(error) > 10
